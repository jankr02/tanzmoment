...
export class DanceStylesSectionComponent {
   ...
   * Fill colour of the boundary wave above the journey — reads as the
   * surrounding section's bottom edge.
   */
  @Input() previousSectionBackground: SectionBackground | string = 'surface';

  /**
   * Background der Section UNTER der Journey (mobile only).
   * Fill colour of the boundary wave below the journey — reads as the
   * surrounding section's top edge.
   */
